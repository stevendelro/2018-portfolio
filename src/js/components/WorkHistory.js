        ...
        <div className="experience">
          ...
          <div className="experience__text">
            ...
            <p>
              ...
              the clientele. I spent my last year with them as a vet technician,
              assisting the veterinarians with all procedures and protocols.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="experience">
          ...
          <div className="experience__text">
            ...
            <p>
              ...
              first job where I proved to myself that I have what it takes to be
              a leader. As an entry level employee, I worked my way up to to
              shift manager. Here, I developed my work ethic, my sense of
              urgency, time management, the ability to take ownership of my
              mistakes, and how to cultivate a rich social landscape with all my
              coworkers.
            </p>
          </div>
        </div>
